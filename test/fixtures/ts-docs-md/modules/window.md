[@tauri-apps/api](../README.md) / [Exports](../modules.md) / window
...
- [appWindow](window.md#appwindow)

### Functions

- [availableMonitors](window.md#availablemonitors)
- [currentMonitor](window.md#currentmonitor)
- [getAll](window.md#getall)
- [getCurrent](window.md#getcurrent)
- [primaryMonitor](window.md#primarymonitor)
...
[window.ts:1137](https://github.com/ksnyde/tauri/blob/3a04c036/tooling/api/src/window.ts#L1137)
...
[window.ts:1231](https://github.com/ksnyde/tauri/blob/3a04c036/tooling/api/src/window.ts#L1231)
...
[window.ts:1198](https://github.com/ksnyde/tauri/blob/3a04c036/tooling/api/src/window.ts#L1198)
...
[window.ts:207](https://github.com/ksnyde/tauri/blob/3a04c036/tooling/api/src/window.ts#L207)
...
[window.ts:195](https://github.com/ksnyde/tauri/blob/3a04c036/tooling/api/src/window.ts#L195)
...
[window.ts:1216](https://github.com/ksnyde/tauri/blob/3a04c036/tooling/api/src/window.ts#L1216)
